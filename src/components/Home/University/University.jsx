...
function University(props) {
  ...
  const [dataMore, setDataMore] = useState(3);
  ...
  const handleMouseMove = (e) => {
    setOnMouseMove(
      Math.ceil(e.nativeEvent.offsetX /(e.currentTarget.clientWidth / (images.length - 1))
      )
    );
  };
              ...
              <CardContent>
                ...
                >
                  <Box
                    ...
                    src={images[onmousemove === -0 ? 0 : onmousemove].imgPath}
                    alt="image"
                  />
                </Box>
              </CardContent>
